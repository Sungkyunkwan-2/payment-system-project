...
### 개발 기간
- **전체 기간**: [개발 기간 입력]
- **기획 및 설계**: [기간 입력] 도메인 설계, ERD 작성, API 명세 정의
- **핵심 기능 개발**: [기간 입력] 결제·환불·구독 로직, PortOne 연동, 포인트·멤버십 시스템
- **CI/CD 구축**: [기간 입력] GitHub Actions, AWS 배포 자동화
- **테스트 및 배포**: [기간 입력] 단위 테스트, 통합 테스트, 운영 환경 배포
