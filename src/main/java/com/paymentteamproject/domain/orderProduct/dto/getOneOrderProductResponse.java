...
public class getOneOrderProductResponse {
    ...
    public getOneOrderProductResponse(Long orderNumber, Long orderId, BigDecimal totalAmount, BigDecimal userPoints, BigDecimal finalAmount, BigDecimal earnedPoints, String currency, OrderStatus status, LocalDateTime createdAt) {
