...
public class getAllOrderProductResponse {
    ...
    public getAllOrderProductResponse(Long orderNumber, Long orderId, double totalAmount, double userPoints, double finalAmount, double earnedPoints, String currency, OrderStatus status, LocalDateTime createdAt) {
